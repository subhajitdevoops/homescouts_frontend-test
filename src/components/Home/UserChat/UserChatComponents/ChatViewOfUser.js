...
import SenderView from "./MessageView/SenderView";
import ReceiverView from "./MessageView/ReceiverView";
import pic from "../pic.jpg";

function ChatViewOfUser() {
  return (
    <div className={`${UC.ChatViewOfUser}`}>
      <div className={`${UC.messagesDiv}`}>
        <ReceiverView />
        <SenderView />
        <ReceiverView />
        <SenderView />
